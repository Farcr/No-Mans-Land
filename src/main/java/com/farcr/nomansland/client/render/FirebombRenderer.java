...
public class FirebombRenderer extends ThrowableBombRenderer<FirebombEntity> {
    ...
    private static final ResourceLocation MODEL = ResourceLocation.fromNamespaceAndPath(NoMansLand.MODID, "entity/firebomb");
    ...
    public ModelResourceLocation getModelLocation(FirebombEntity entity) {
        return ModelResourceLocation.inventory(MODEL);
    }
}