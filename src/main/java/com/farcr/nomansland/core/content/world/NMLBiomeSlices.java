...
//Huge shoutout to Bagel for helping with this - as you can see it's a heavily modified Autumnity Biome Slice class!
public class NMLBiomeSlices {

    public static final ResourceKey<ModdedBiomeSlice> AUTUMNAL = createKey("autumnal");

    private static final ResourceKey<Biome> MAPLE_FOREST_MIDDLE = NMLBiomes.createKey("maple_forest_middle");
    private static final ResourceKey<Biome> MAPLE_FOREST_MIDDLE_VARIANT = NMLBiomes.createKey("maple_forest_middle_variant");
    private static final ResourceKey<Biome> MAPLE_FOREST_PLATEAU = NMLBiomes.createKey("maple_forest_plateau");
    private static final ResourceKey<Biome> MAPLE_FOREST_PLATEAU_VARIANT = NMLBiomes.createKey("maple_forest_plateau_variant");
    ...
    public static void bootstrap(BootstapContext<ModdedBiomeSlice> context) {
        ...
        context.register(AUTUMNAL, new ModdedBiomeSlice(20,
                MultiNoiseModdedBiomeProvider.builder()
                        .biomes(entries::forEach)
                        .area(MAPLE_FOREST_MIDDLE, NMLBiomes.MAPLE_FOREST)
                        .area(MAPLE_FOREST_MIDDLE_VARIANT, NMLBiomes.MAPLE_FOREST)
                        .area(MAPLE_FOREST_PLATEAU, NMLBiomes.MAPLE_FOREST)
                        .area(MAPLE_FOREST_PLATEAU_VARIANT, NMLBiomes.MAPLE_FOREST)
    ...
    private static final class AutumnBiomeBuilder {
        ...
        private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {MAPLE_FOREST_MIDDLE, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
